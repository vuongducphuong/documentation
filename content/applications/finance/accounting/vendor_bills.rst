...
- :guilabel:`Vendor`: Leansoft automatically fills some information based on the vendor's registered
...
pay (full or partial payment), and the :guilabel:`Currency`. Leansoft fills the :guilabel:`Memo` field
